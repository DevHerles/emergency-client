...
/* EMERGENCY CALLS APP*/
export const CALLS_GET_LIST = "CALLS_GET_LIST";
export const CALLS_GET_LIST_SUCCESS = "CALLS_GET_LIST_SUCCESS";
export const CALLS_GET_LIST_ERROR = "CALLS_GET_LIST_ERROR";
export const CALLS_GET_LIST_WITH_FILTER = "CALLS_GET_LIST_WITH_FILTER";
export const CALLS_GET_LIST_WITH_ORDER = "CALLS_GET_LIST_WITH_ORDER";
export const CALLS_GET_LIST_SEARCH = "CALLS_GET_LIST_SEARCH";
export const CALLS_ADD_ITEM = "CALLS_ADD_ITEM";
export const CALLS_ADD_ITEM_SUCCESS = "CALLS_ADD_ITEM_SUCCESS";
export const CALLS_ADD_ITEM_ERROR = "CALLS_ADD_ITEM_ERROR";
export const CALLS_SELECTED_ITEMS_CHANGE = "CALLS_SELECTED_ITEMS_CHANGE";
